<div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
        <div class="container">
            <br><br>
            <h1 class="header center white-text text-uppercase text-lighten-2">ONE ACCESS</h1>
    ...
    <div class="parallax"><img src="<?= HOME ?>image/assets/img/background4.png&w=1920" alt="Acesso ao Login"></div>
</div>
...
<div class="parallax-container valign-wrapper">
    ...
    <div class="parallax"><img src="<?= HOME ?>assets/img/background2.jpg" alt="Unsplashed background img 2"></div>
</div>
...
<div class="parallax-container valign-wrapper">
    ...
    <div class="parallax"><img src="<?= HOME ?>assets/img/background3.jpg" alt="Unsplashed background img 3"></div>
</div>
...
<footer class="page-footer teal">
    ...
    <div class="footer-copyright">
        <div class="container">
            Made by <a class="brown-text text-lighten-3" target="_blank" href="http://singlefw.com">Single FW</a>
        </div>
    </div>
</footer>